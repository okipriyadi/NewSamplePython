"""
reactor tidak akan berfungsi sebelum di run, oleh karena itu tulisan "'Hello from the reactor loop!'" 
muncul setelah tulisan 'Starting the reactor.' 

callWhenRunning akan berjlan saat reactor.run() dieksekusi
callWhenRunning harus ditulis sebelum reactor.run karna ca;;WhenRunning dieksekusi berbarengan 
