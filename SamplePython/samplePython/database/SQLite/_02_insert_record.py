...
# Create employees.
#gunakan kutip tiga kali agar syntax sql tidak mejadi masalah jika kita enter (bagi menjadi beberapa baris) untuk readability 
cursor.execute(""" insert into employee (empid,firstname,lastname,manager,dept,phone)
